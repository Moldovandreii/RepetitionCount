...
class StatusActivity : AppCompatActivity() {
    ...
    fun updateDiet(){
        ...
        var finalProteins = weight!! * proteinsPerKg
        finalProteins = String.format("%.2f", finalProteins).toDouble()
        var finalFats = (fatPercent / 100.0) * finalCalories
        ...
        if(proteinsBalance > 0){
            proteinsBalanceText = proteinsBalance.toString() + " remaining"
        }else{
        ...
        var fatsBalanceTxt = ""
        if(fatsBalance > 0){
            fatsBalanceTxt = fatsBalance.toString() + " remaining"
        }else{
            fatsBalanceTxt = "Surplus of " + fatsBalance.toString()
        }
        caloriesText.text = "Calories: " + caloriesRounded.toString() + " - " + caloriesBalanceTxt
        proteinsText.text = "Proteins: " + proteinsRounded.toString() + " - " + proteinsBalanceText
        fatsText.text = "Fats: " + fatsRounded.toString() + " - " + fatsBalanceTxt
    }
}